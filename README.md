# Un projet informatique réalisé pour un proche
...
UPDATE 18.01.2026 : Juste une note pour dire que j'ai ajouté une page de login et une interface administrateur sommaire sur le site en octobre/novembre. Je l'ai programmé en m'appuyant sur plusieurs sources (dont j'ai oublié le nom, d'ailleurs - si on tape "login page html css js" sur Google on trouve le modèle normalement). Je suis sur d'autres projets en ce moment, donc je n'ai plus pu avancer sur ce projet-ci, mais je me suis souvenu ce matin du 18 janvier que je n'avais jamais fait l'update pour ce dont je parlais le 12 octobre à la fin de la note de mise à jour, alors que je l'avais fait.
